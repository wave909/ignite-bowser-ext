...
import {StatusBar, StatusBarProps, StyleProp, StyleSheet, View, ViewStyle} from "react-native";
 ...
 */
export function createBasicNavigationOptions(title: string, icons?: ReactElement<any>): NavigationScreenOptions {
    return {
        title,
